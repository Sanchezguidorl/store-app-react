...
function Contact() {
  return (
    <Container id="Contact" className="my-5">
      ...
      <p>
        <b>🌟 Quality Assured</b>: Our products undergo rigorous quality checks
        to ensure they meet the highest standards. We take pride in delivering
        items that not only meet but exceed customer expectations.
      </p>
      </Col>
      <Col xs={12} md={6} lg={3} className='border rounded p-2 mb-1 mb-lg-0'>
      <p>
        <b>🚀 Innovation at Its Best</b>: Stay ahead of the curve with our
        cutting-edge and trendsetting merchandise. Our team keeps a close eye on
        market trends to offer you the latest and most sought-after products.
      </p>
      </Col>
      <Col xs={12} md={6} lg={3} className='border rounded p-2 mb-1 mb-lg-0'>
      <p>
        <b>🤝 Partnership Approach</b>: We don&apos;t just consider you a
        customer – we view you as a partner. Your success is our success, and
        we&apos;re committed to working hand-in-hand to achieve mutual growth.
      </p>
      </Col>
      <Col xs={12} md={6} lg={3} className='border rounded p-2 mb-1 mb-lg-0'>
      <p>
        <b>💡 Customization Options</b>: We understand that each business is
        unique. That&apos;s why we offer customization options that let you add
        your own touch to the products, helping you stand out in the market.
      </p>
      </Col>
      </Row>
